...
function getProvince(){
	...
	var items = dsy.Items["0"];
	for( var i = 0 ; i < items.length; i++ ){
		var province=[];
		province.id=items[i];
		province.text=items[i];
		province.index="0_"+i;
...
function getCity( currProvinceIndex ){
	var provinceArray = new Array();
	var items = dsy.Items[currProvinceIndex];
	for( var i = 0 ; i < items.length; i++ ){
		var province=[];
		province.id=items[i];
		province.text=items[i];
		province.index=currProvinceIndex + "_" + i;
		provinceArray[i] = province;
	}
	return provinceArray;
}

function getCityIndex( province,city ){
	var items = dsy.Items[ province ];
	for( var i = 0 ; i < items.length; i++ ){
		if( city == items[i] ){
			return province+"_"+i;
		}
...
function getDistrict( currCityIndex ){
	var provinceArray = new Array();
	var items = dsy.Items[currCityIndex];
	for( var i = 0 ; i < items.length; i++ ){
		var province=[];
		province.id=items[i];
		province.text=items[i];
